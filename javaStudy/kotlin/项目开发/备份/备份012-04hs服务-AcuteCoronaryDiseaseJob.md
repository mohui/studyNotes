...
import com.bjknrt.health.scheme.constant.ACUTE_CORONARY_DISEASE_HEALTH_MANAGE_JOB_NAME
...
val patientClient: PatientApi
    ...
    fun listener(event: SaveHealthManageEvent) {
        ...
        val jobId = XxlJobRpcUtil.createJobWithFixedRate(
            ...
            ACUTE_CORONARY_DISEASE_HEALTH_MANAGE_JOB_NAME,
    ...
    @XxlJob(ACUTE_CORONARY_DISEASE_HEALTH_MANAGE_JOB_NAME)
    @Transactional
    fun acuteCoronaryDiseaseHealthManageJobHandler() {
        XxlJobHelper.log("start exec acuteCoronaryDiseaseHealthManageJobHandler.....")
